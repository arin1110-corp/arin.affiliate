        ...
        <form method="POST"
            ...
            <div>
                ...
                <div class="flex mt-1">
                    ...
                    <input type="text"
                           name="user_slug"
                           value="{{ old('user_slug', $user->user_slug) }}"
                           class="flex-1 p-3 rounded-r-xl border border-gray-200"
                           required>
                </div>

                <p class="text-xs text-gray-400 mt-1">
                    Gunakan huruf kecil, angka, dan tanda strip. Contoh: toko-parfum
                </p>
            </div>
            ...
            <div>
                ...
                <textarea name="user_description"
                          rows="4"
                          placeholder="Tulis deskripsi singkat tentang website affiliate kamu."
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    @if ($user->user_logo)
                        <img src="{{ asset($user->user_logo) }}"
                             class="w-20 h-20 rounded-2xl object-cover mt-3">
                    @endif
                </div>
                ...
                <div>
                    ...
                    @if ($user->user_favicon)
                        <img src="{{ asset($user->user_favicon) }}"
                             class="w-12 h-12 rounded-xl object-cover mt-3">
                    @endif
                </div>
            ...
            <details class="border border-gray-200 rounded-2xl p-4">
                ...
                <div class="space-y-4 mt-4">
                    ...
                    <div>
                        ...
                        <textarea name="user_meta_description"
                                  rows="3"
                                  class="w-full mt-1 p-3 rounded-xl border border-gray-200">{{ old('user_meta_description', $user->user_meta_description) }}</textarea>
                    </div>
    ...
    <div>
        <div class="bg-white/80 backdrop-blur-xl border theme-border rounded-3xl shadow p-6 sticky top-6">
            ...
            <div class="flex flex-col gap-3 mt-4">
                ...
                <button type="button"
                        onclick="copyLink('{{ url('/' . $user->user_slug) }}')"
