        ...
        <div class="lg:col-span-2">
            ...
            <form method="POST" action="{{ route('client.setting.update') }}" enctype="multipart/form-data"
                ...
                <div>
                    ...
                    <div class="flex mt-1">
                        ...
                        <input type="text" name="user_slug" value="{{ old('user_slug', $user->user_slug) }}"
                            class="flex-1 p-3 rounded-r-xl border border-gray-200" required>
                    </div>
                ...
                <div class="border-t pt-6">
                    ...
                    <p class="text-sm text-gray-500">
                        Opsional, isi jika ingin ditampilkan di footer.
                    </p>
                </div>
                ...
                <div class="border-t pt-6">
                    ...
                    <p class="text-sm text-gray-500">
                        Warna ini akan langsung mengubah tampilan website publik kamu.
                    </p>
                </div>
            ...
            <div class="bg-white rounded-3xl shadow p-6 sticky top-6">
                ...
                <div class="flex flex-col gap-3 mt-4">
                    <a href="{{ url('/' . $user->user_slug) }}" target="_blank"
                        class="bg-pink-600 text-white px-5 py-3 rounded-2xl text-center">
                        Lihat Website
                    </a>

                    <button type="button" onclick="copyLink('{{ url('/' . $user->user_slug) }}')"
