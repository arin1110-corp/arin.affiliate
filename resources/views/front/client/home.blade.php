        ...
        <div class="relative overflow-hidden rounded-[32px] bg-white/70 border theme-border shadow-xl">
            ...
            <div class="min-h-[320px] md:min-h-[440px] flex items-center">
                <div class="p-8 md:p-12 max-w-2xl">
                    ...
                    <a href="#produk"
                       class="inline-block mt-6 theme-button px-6 py-3 rounded-2xl font-semibold">
                        Jelajahi Produk
                    </a>
                ...
                <div class="w-56 h-56 rounded-[40px] theme-soft flex items-center justify-center">
                    @if($client->user_logo)
                        <img src="{{ asset($client->user_logo) }}"
                             class="w-32 h-32 rounded-[32px] object-cover">
                    @else
                        <div class="w-32 h-32 rounded-[32px] theme-button flex items-center justify-center text-5xl font-bold">
    ...
    @if(isset($kategori) && $kategori->count())
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            @foreach($kategori as $kat)
                <div class="bg-white/70 backdrop-blur-xl border theme-border rounded-3xl p-4 hover:shadow-xl transition">

                    @if($kat->kategori_thumbnail)
                        <img src="{{ asset($kat->kategori_thumbnail) }}"
                             class="w-full h-32 object-cover rounded-2xl mb-4">
                    @else
                        <div class="w-full h-32 theme-soft rounded-2xl mb-4 flex items-center justify-center theme-text font-bold">
